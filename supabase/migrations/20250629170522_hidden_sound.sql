...
BEGIN
  ...
  -- Drop beta applications policies
  DROP POLICY IF EXISTS "Anyone can submit beta applications" ON beta_applications;
  DROP POLICY IF EXISTS "Users can view their own beta applications" ON beta_applications;
  
  -- Drop tutorial progress policies
  DROP POLICY IF EXISTS "Users can manage their own tutorial progress" ON tutorial_progress;
...
-- Create beta applications policies
...
-- Create tutorial progress policies
